...
<section class="policies_wrap container clearfix">
    ...
    <h2>제 1 조 (목적)</h2>
    <p>이 약관은 ㈜나누다(이하 "회사")가 제공하는 나누다뮤직 관련 제반 서비스의 이용과 관련하여 회사와 회원과의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.</p>

    <h2>제 2 조 (정의)</h2>
    <p>이 약관에서 사용하는 용어의 정의는 다음과 같습니다.</p>
    <ol>
        <li>"서비스"라 함은 구현되는 단말기(PC, TV, 휴대형단말기 등의 각종 유무선 장치를 포함)와 상관없이 "회원"이 이용할 수 있는 나누다뮤직 관련 제반 서비스를 의미합니다.</li>
        ...
        <li>"유료서비스"라 함은 "회사"가 유료로 제공하는 각종 온라인디지털콘텐츠(각종 프리미엄서비스 아이템 및 기타 유료콘텐츠를 포함) 및 제반 서비스를 의미합니다.</li>
        <li>"나누다뮤직캐쉬"라 함은 서비스의 효율적 이용을 위해 회사가 임의로 책정 또는 지급, 조정할 수 있는 재산적 가치가 있어 출금절차를 통해 현금화 할 수 있는 "서비스" 상의 가상 화폐를 의미합니다.</li>
    ...
    <ol>
        ...
        <li>2항의 변경사항을 "회사"에 알리지 않아 발생한 불이익에 대하여 "회사"는 책임지지 않습니다.</li>
    </ol>
    ...
    <ol>
        ...
        <li>"회원"은 관계법, 이 약관의 규정, 가이드라인, 이용설명서 및 "서비스"와 관련하여 공지한 주의사항, "회사"가 통지하는 사항 등을 준수하여야 하며, 기타 "회사"의 업무에 방해되는 행위를 하여서는 안 됩니다.</li>
    </ol>
    ...
    <ol>
        <li>회사는 회원에게 아래와 같은 서비스를 제공합니다.
            <ol>
                <li>① 재능거래 서비스 – 회원의 재능 상품을 예약금액과 서비스 수수료를 결제하여 예약하는 방식으로, 재능 예약금액을 제외한 나머지 금액은 구매한 회원과 판매한 회원이 합의하여 거래하는 서비스</li>
                <li>② 재능요청 서비스 </li>
                <li>③ 재능 이벤트 서비스</li>
    ...
    <ol>
        ...
        <li>"회원"이 "서비스" 내에 게시하는 "게시물"은 "서비스" 및 관련 프로모션 등에 노출될 수 있으며, 해당 노출을 위해 필요한 범위 내에서는 일부 수정, 복제, 편집되어 게시될 수 있습니다. 이 경우, 회사는 저작권법 규정을 준수하며, "회원"은 언제든지 고객센터 또는 "서비스" 내 관리기능을 통해 해당 게시물에 대해 삭제, 검색결과 제외, 비공개 등의 조치를 취할 수 있습니다.</li>
    ...
    <ol>
        ...
        <li>"회사"는 서비스와 관련하여 "회원"에게 "회사"가 정한 이용조건에 따라 계정, "아이디", 콘텐츠, "나누다캐쉬" 등을 이용할 수 있는 이용권만을 부여하며, "회원"은 이를 양도, 판매, 담보제공 등의 처분행위를 할 수 없습니다.</li>
    </ol>

    <h2>제 18 조 (나누다뮤직캐쉬)</h2>
    <p>나누다뮤직캐쉬 출금을 위해 본인 인증이 완료된 은행 계좌가 필요하며, 본인 인증 후 출금 계좌정보를 입력해야 합니다. 나누다뮤직캐쉬 금액이 10,000원 이상이면 인출요청이 가능하며, 출금 요청 후 등록된 본인 계좌로 법정공휴일 및 주말기간을 제외 후 3일 이내에 회원 계좌로 요청 금액을 입금합니다.</p>

    <h2>제 19 조 (계약해제, 해지 등)</h2>
    <ol>
        ...
        <li>"회원"이 계약을 해지하는 경우, "회원"이 작성한 "게시물" 일체는 삭제됩니다. 다만, 공용게시판에 등록된 "게시물" 등은 삭제되지 않으니 사전에 삭제 후 탈퇴하시기 바랍니다.</li>
    </ol>
    ...
    <h2>부칙</h2>
    <ol>
        <li>이 약관은 2013년 9월 1일부터 적용됩니다.</li>
    </ol>
